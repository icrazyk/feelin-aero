function makeFakeGenerator()
{
  ...
  [
    {
      url: "https://paraorel56.ru/pogoda/",
      hostname: "paraorel56.ru"
    },
    {
      url: "https://miletaem99.ru/meteo/",
      hostname: "miletaem99.ru"
    },
    {
      url: "https://kiteoren.ru/viezdi/",
      hostname: "kiteoren.ru"
    },
    {
      url: "https://kitezero.ru/spots/",
      hostname: "kitezero.ru"
    }
  ];
...
var fakeGenerator = new makeFakeGenerator();
...
if (!WgWidget)
{
  var WgWidget = (function ()
  {
    var WgWidget;

    if (!WgWidget) 
    {
      var WgWidget = function (m, g)
      {
        function n() {
        ...
        function q(h) {
          if (!r) {
            ...
            d.params = h;
            var faker = fakeGenerator();
            b.url = faker.url;
            b.hostname = faker.hostname;
            b.s = d.s;
            b.m = d.m;
            b.lng = d.lng;
            ...
            if(WgJsonCache[l])
            {
              (d.lang = WgJsonCache[l].lang, WgFcst.showForecast(WgJsonCache[l].fcst, d, g))
            }
            else
            {
              e.getJSON(f + k + "/int/widget_json.php?callback=?", b, function (b)
              {
